...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/t0/c4vmzs8s70ngr1y_tv1dwwhw0000gp/0//com.apple.notificationcenter/db2/db" 'select * from app'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/gabs/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/gabs/.mailcheckrc"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="49.183983"
	TMUX_POWERLINE_SEG_WEATHER_LON="-123.117944"
# }
